...
enum
{
  ramen_interfaces__action__ServeRamen_SendGoal_Event__request__MAX_SIZE = 1
};
// response
enum
{
  ramen_interfaces__action__ServeRamen_SendGoal_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/ServeRamen in the package ramen_interfaces.
typedef struct ramen_interfaces__action__ServeRamen_SendGoal_Event
{
  service_msgs__msg__ServiceEventInfo info;
  ramen_interfaces__action__ServeRamen_SendGoal_Request__Sequence request;
  ramen_interfaces__action__ServeRamen_SendGoal_Response__Sequence response;
} ramen_interfaces__action__ServeRamen_SendGoal_Event;

// Struct for a sequence of ramen_interfaces__action__ServeRamen_SendGoal_Event.
typedef struct ramen_interfaces__action__ServeRamen_SendGoal_Event__Sequence
{
...
enum
{
  ramen_interfaces__action__ServeRamen_GetResult_Event__request__MAX_SIZE = 1
};
// response
enum
{
  ramen_interfaces__action__ServeRamen_GetResult_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/ServeRamen in the package ramen_interfaces.
typedef struct ramen_interfaces__action__ServeRamen_GetResult_Event
{
  service_msgs__msg__ServiceEventInfo info;
  ramen_interfaces__action__ServeRamen_GetResult_Request__Sequence request;
  ramen_interfaces__action__ServeRamen_GetResult_Response__Sequence response;
} ramen_interfaces__action__ServeRamen_GetResult_Event;

// Struct for a sequence of ramen_interfaces__action__ServeRamen_GetResult_Event.
typedef struct ramen_interfaces__action__ServeRamen_GetResult_Event__Sequence
{
