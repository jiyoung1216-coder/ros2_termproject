...
#include "ramen_interfaces/msg/detail/cooked_ramen__rosidl_typesupport_fastrtps_c.h"
...
#include "ramen_interfaces/msg/detail/ramen_order__functions.h"  // order
...
using _CookedRamen__ros_msg_type = ramen_interfaces__msg__CookedRamen;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: order
  {
    cdr_serialize_ramen_interfaces__msg__RamenOrder(
      &ros_message->order, cdr);
  }
  ...
  ramen_interfaces__msg__CookedRamen * ros_message)
{
  // Field name: order
  {
    cdr_deserialize_ramen_interfaces__msg__RamenOrder(cdr, &ros_message->order);
  }
...
size_t get_serialized_size_ramen_interfaces__msg__CookedRamen(
  ...
  size_t current_alignment)
{
  const _CookedRamen__ros_msg_type * ros_message = static_cast<const _CookedRamen__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  // Field name: order
  current_alignment += get_serialized_size_ramen_interfaces__msg__RamenOrder(
    &(ros_message->order), current_alignment);
  ...
  size_t current_alignment)
{
  ...
  // Field name: order
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_ramen_interfaces__msg__RamenOrder(
  ...
  if (is_plain) {
    ...
    using DataType = ramen_interfaces__msg__CookedRamen;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: order
  {
    cdr_serialize_key_ramen_interfaces__msg__RamenOrder(
      &ros_message->order, cdr);
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: order
  current_alignment += get_serialized_size_key_ramen_interfaces__msg__RamenOrder(
    &(ros_message->order), current_alignment);
  ...
  size_t current_alignment)
{
  ...
  // Field name: order
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_ramen_interfaces__msg__RamenOrder(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
static bool _CookedRamen__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ramen_interfaces__msg__CookedRamen * ros_message = static_cast<const ramen_interfaces__msg__CookedRamen *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ramen_interfaces__msg__CookedRamen(ros_message, cdr);
}

static bool _CookedRamen__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  ramen_interfaces__msg__CookedRamen * ros_message = static_cast<ramen_interfaces__msg__CookedRamen *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ramen_interfaces__msg__CookedRamen(cdr, ros_message);
}

static uint32_t _CookedRamen__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ramen_interfaces__msg__CookedRamen(
      untyped_ros_message, 0));
}

static size_t _CookedRamen__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_ramen_interfaces__msg__CookedRamen(
...
static message_type_support_callbacks_t __callbacks_CookedRamen = {
  "ramen_interfaces::msg",
  "CookedRamen",
  _CookedRamen__cdr_serialize,
  _CookedRamen__cdr_deserialize,
  _CookedRamen__get_serialized_size,
  _CookedRamen__max_serialized_size,
  nullptr
};

static rosidl_message_type_support_t _CookedRamen__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_CookedRamen,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ramen_interfaces, msg, CookedRamen)() {
  return &_CookedRamen__type_support;
}
