...
static rosidl_typesupport_introspection_c__MessageMember ramen_interfaces__msg__RamenOrder__rosidl_typesupport_introspection_c__RamenOrder_message_member_array[8] = {
  {
    "table_number",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ramen_interfaces__msg__RamenOrder, total_price),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ramen_interfaces__msg__RamenOrder, payment_method),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ramen_interfaces__msg__RamenOrder, pay_now),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ramen_interfaces__msg__RamenOrder, currency),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
