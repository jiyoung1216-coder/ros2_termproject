...
inline void to_flow_style_yaml(
  const ServeRamen_SendGoal_Event & msg,
  std::ostream & out)
{
  out << "{";
  // member: info
...
inline std::string to_yaml(const ServeRamen_SendGoal_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use ramen_interfaces::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const ramen_interfaces::action::ServeRamen_SendGoal_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  ramen_interfaces::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use ramen_interfaces::action::to_yaml() instead")]]
inline std::string to_yaml(const ramen_interfaces::action::ServeRamen_SendGoal_Event & msg)
{
  return ramen_interfaces::action::to_yaml(msg);
}

template<>
inline const char * data_type<ramen_interfaces::action::ServeRamen_SendGoal_Event>()
{
  return "ramen_interfaces::action::ServeRamen_SendGoal_Event";
}

template<>
inline const char * name<ramen_interfaces::action::ServeRamen_SendGoal_Event>()
{
  return "ramen_interfaces/action/ServeRamen_SendGoal_Event";
}

template<>
struct has_fixed_size<ramen_interfaces::action::ServeRamen_SendGoal_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<ramen_interfaces::action::ServeRamen_SendGoal_Event>
  : std::integral_constant<bool, has_bounded_size<ramen_interfaces::action::ServeRamen_SendGoal_Request>::value && has_bounded_size<ramen_interfaces::action::ServeRamen_SendGoal_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<ramen_interfaces::action::ServeRamen_SendGoal_Event>
  : std::true_type {};
...
inline void to_flow_style_yaml(
  const ServeRamen_GetResult_Event & msg,
  std::ostream & out)
{
  out << "{";
  // member: info
...
inline std::string to_yaml(const ServeRamen_GetResult_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use ramen_interfaces::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const ramen_interfaces::action::ServeRamen_GetResult_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  ramen_interfaces::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use ramen_interfaces::action::to_yaml() instead")]]
inline std::string to_yaml(const ramen_interfaces::action::ServeRamen_GetResult_Event & msg)
{
  return ramen_interfaces::action::to_yaml(msg);
}

template<>
inline const char * data_type<ramen_interfaces::action::ServeRamen_GetResult_Event>()
{
  return "ramen_interfaces::action::ServeRamen_GetResult_Event";
}

template<>
inline const char * name<ramen_interfaces::action::ServeRamen_GetResult_Event>()
{
  return "ramen_interfaces/action/ServeRamen_GetResult_Event";
}

template<>
struct has_fixed_size<ramen_interfaces::action::ServeRamen_GetResult_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<ramen_interfaces::action::ServeRamen_GetResult_Event>
  : std::integral_constant<bool, has_bounded_size<ramen_interfaces::action::ServeRamen_GetResult_Request>::value && has_bounded_size<ramen_interfaces::action::ServeRamen_GetResult_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<ramen_interfaces::action::ServeRamen_GetResult_Event>
  : std::true_type {};
